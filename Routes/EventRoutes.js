...
router.get('/Event',  passport.authenticate('bearer', { session: false }), FetchEvent)
router.get('/EventAlumni',  passport.authenticate('bearer', { session: false }), authRole("Alumni") , FetchEvent)
