...
router.put('/Enseignant/:idEnseignant',  passport.authenticate('bearer', { session: false }), authRole("ADMIN") , UpdateEnseignant)
router.put('/EnseignantUpdate/:idEnseignant',  passport.authenticate('bearer', { session: false }), authRole( "Enseignant") , UpdateEnseignant)
